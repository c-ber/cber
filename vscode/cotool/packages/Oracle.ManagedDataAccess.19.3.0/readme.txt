Oracle.ManagedDataAccess NuGet Package 19.3.0 README
====================================================
...
New Features
============
1. Managed ODP.NET supports OracleConfiguration class to enable configuration as code.
2. .NET Framework 4.8 is certified with managed ODP.NET.

Additional new features in this release are described in the ODP.NET Developer's Guide:
https://docs.oracle.com/en/database/oracle/oracle-database/19/odpnt/release_changes.html


Bug Fixes since Oracle.ManagedDataAccess NuGet Package 18.6.0
=============================================================
None
