...
string LootIs(string LootIsm)
{
	string ism = "";
	if (LootIsm== "Item_Back_E_02_Lv1_C") { ism = "Lv1 Canta"; }
	else if (LootIsm== "Item_Back_F_02_Lv2_C") { ism = "Lv2 Canta"; }
	else if (LootIsm== "Item_Back_C_02_Lv3_C") { ism = "Lv3 Canta"; }

	else if (LootIsm== "Item_Back_E_01_Lv1_C") { ism = "Lv1 Canta"; }
	else if (LootIsm== "Item_Back_F_01_Lv2_C") { ism = "Lv2 Canta"; }
	else if (LootIsm== "Item_Back_C_01_Lv3_C") { ism = "Lv3 Canta"; }


	else if (LootIsm== "Item_Armor_D_01_Lv2_C") { ism = "Lv2 Yelek"; }
	else if (LootIsm== "Item_Armor_C_01_Lv3_C") { ism = "Lv3 Yelek"; }

	else if (LootIsm== "Item_Armor_D_02_Lv2_C") { ism = "Lv2 Yelek"; }
	else if (LootIsm== "Item_Armor_C_02_Lv3_C") { ism = "Lv3 Yelek"; }

	else if (LootIsm== "Item_Head_F_02_Lv2_C") { ism = "Lv2 Kask"; }
	else if (LootIsm== "Item_Head_G_02_Lv3_C") { ism = "Lv3 Kask"; }

	else if (LootIsm== "Item_Head_F_01_Lv2_C") { ism = "Lv2 Kask"; }
	else if (LootIsm== "Item_Head_G_01_Lv3_C") { ism = "Lv3 Kask"; }

	else if (LootIsm== "Item_Heal_FirstAid_C") { ism = "FirstAid"; }
	else if (LootIsm== "Item_Heal_MedKit_C") { ism = "MedKit"; }


	else if (LootIsm== "Item_Weapon_AK47_C") { ism = "AK47"; }
	else if (LootIsm== "Item_Weapon_SCAR-L_C") { ism = "Scar-L"; }
	else if (LootIsm== "Item_Weapon_Pan_C") { ism = "Tava"; }
	else if (LootIsm== "Item_Weapon_Kar98k_C") { ism = "Kar98"; }
	else if (LootIsm== "Item_Weapon_M16A4_C") { ism = "M16A4"; }
	else if (LootIsm== "Item_Weapon_HK416_C") { ism = "M416"; }
	else if (LootIsm== "Item_Weapon_Mini14_C") { ism = "Mini14"; }
	else if (LootIsm== "Item_Weapon_UMP_C") { ism = "UMP"; }



	else if (LootIsm== "Item_Attach_Weapon_Muzzle_Suppressor_Large_C") { ism = "Supp(SR)"; }
	else if (LootIsm== "Item_Attach_Weapon_Muzzle_Suppressor_Large") { ism = "Supp(AR)"; }
	else if (LootIsm== "Item_Attach_Weapon_Muzzle_Suppressor_SniperRifle") { ism = "Supp(SRR)"; }



	else if (LootIsm== "Item_Attach_Weapon_Muzzle_FlashHider_SniperRifle_C") { ism = "SR(FH)"; }


	else if (LootIsm== "Item_Attach_Weapon_Muzzle_Compensator_SniperRifle_C") { ism = "Comp(AR)"; }
	else if (LootIsm== "Item_Attach_Weapon_Muzzle_Compensator_Large_C") { ism = "Comp(SR)"; }


	else if (LootIsm== "Item_Attach_Weapon_Magazine_ExtendedQuickDraw_Large_C") { ism = "Sarsor(AR)"; }
	else if (LootIsm== "Item_Attach_Weapon_Magazine_ExtendedQuickDraw_SniperRifle_C") { ism = "Sarsor(SR)"; }


	else if (LootIsm== "Item_Attach_Weapon_Upper_Aimpoint_C") { ism = "2x"; }
	else if (LootIsm== "Item_Attach_Weapon_Upper_ACOG_01_C") { ism = "4x"; }
	else if (LootIsm== "Item_Attach_Weapon_Upper_CQBSS_C") { ism = "8x"; }

	else if (LootIsm== "Item_Attach_Weapon_Upper_DotSight_01_C") { ism = "Reddot"; }
